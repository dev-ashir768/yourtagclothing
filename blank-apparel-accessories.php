...
<div id="pjax-container" itemscope="" itemprop="Product" itemtype="http://schema.org/Product">
  <span itemprop="name" content="Blank Apparel   Accessories wholesale and retail. "></span>
      ...
      <div>
        <form class="flex justify-between items-start mt-4 md:!mt-8" action="/product" accept-charset="UTF-8" method="post">
              ...
              <div x-data="{ open: true }">
                ...
                <div class="py-4 px-6" x-cloak="true" x-show="open" x-transition>
                  ...
                  <div class="grid grid-cols-7 gap-4">
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/black-and-white-m66"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/turquoise-m65"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_Turquoise"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/lime-green-m64"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/beige-m61"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_Beige"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/navy-blue-m41"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_Navy Blue"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/burgundy-m56"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_Burgundy"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/red-m24"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_red"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/pink-m21"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_pink"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/purple-m27"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_Purple"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/blue-m6"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_blue"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/sky-blue-m60"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_Sky Blue"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/green-m15"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_green"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/yellow-m33"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_yellow"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/orange-m18"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_orange"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/white-m30"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_white"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/brown-m9"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_brown"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/khaki-m53"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_Khaki"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/black-m3"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_black"
                    ...
                    <a
                      href="/blank-apparel-accessories-c37029/gray-m12"
                      class="relative border border-solid rounded-lg mx-auto w-10 h-10 cursor-pointer"
                      :class="false ? &#39;border-black&#39; : &#39;light-border&#39;"
                      for="color_gray"
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class="grid grid-cols-5 gap-2 ">
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/xs-x7">
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/s-x1">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>S</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/m-x2">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>M</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/l-x3">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>L</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/xl-x4">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>XL</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/2xl-x5">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>2XL</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/3xl-x6">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>3XL</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/4xl-x10">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>4XL</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/5xl-x11">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>5XL</span>
                        </div>
                      </a>
                    ...
                    <div
                      ...
                      <a class="block text-xl text-gray-600" href="/blank-apparel-accessories-c37029/6xl-x9">
                        <div class="flex justify-center items-center m-1 border border-solid light-border rounded-xl aspect-square uppercase text-gray-600 ">
                          <span>6XL</span>
                        </div>
                      </a>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/baby-g16549">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/boys-g44705">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Boys</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/geek-g4724">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Geek</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/girls-g44706">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Girls</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/kids-g10">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Kids</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/men-g27">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Men</span>
                        <span class="small">(1685)</span>
                      </a>
                    </div>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/unisex-g4789">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Unisex</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/women-g24">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Women</span>
                        <span class="small">(1661)</span>
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/accessories-s3670">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/bags-s2737">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Bags</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/dress-s2735">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Dress</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/headwear-s2732">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Headwear</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/jackets-s3669">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Jackets</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/long-sleeves-s16378">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/onesies-s16552">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Onesies</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" @click="$store.plp.toggleFilter('/pajamas-s22369', 'style')">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Pajamas</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/pants-shorts">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/shirts-s3671">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Shirts</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/sports-apparel-s21796">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/sweats-fleece-s3668">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/t-shirts-s2729">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>T-Shirts</span>
                        <span class="small">(608)</span>
                      </a>
                    </div>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" @click="$store.plp.toggleFilter('/tank-tops-s6859', 'style')">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Tank Tops</span>
                        <span class="small">(1)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/underwear-s3185">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Underwear</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/workwear-s16558">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Workwear</span>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/custom-o47">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Custom</span>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/3-4-sleeves-a5895">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/long-sleeves-a5892">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Long sleeves</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/short-sleeves-a5893">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/sleeveless-a5894">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/camo-a5924">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Camo</span>
                        <span class="small">(7)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/plaid-a5926">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Plaid</span>
                        <span class="small">(7)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/raglan-a5921">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Raglan</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/ringer-a5948">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Ringer</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/star-a5925">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Star</span>
                        <span class="small">(5)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/striped-a5922">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Striped</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/tie-dye-a5919">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Tie Dye</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/varsity-a5928">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Varsity</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/vintage-a5920">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Vintage</span>
                        <span class="small">(8)</span>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" max-h-52 overflow-y-auto">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/100-cotton-a118">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/100-polyester-a181">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/50-cotton-50-polyester-a319">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/50-50-cotton-poly-a7">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/51-79-cotton-a109">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/60-40-cotton-polyester-a925">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/80-cotton-20-polyester-a529">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/80-cotton-a631">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>&gt; 80% cotton</span>
                        <span class="small">(4)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/acrylic-a169">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Acrylic</span>
                        <span class="small">(17)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/coton-polyester-a136">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/cotton-a103">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Cotton</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/cotton-poly-lycra-a577">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/denim-a5935">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Denim</span>
                        <span class="small">(7)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/duck-a625">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Duck</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/elastane-a1347">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Elastane</span>
                        <span class="small">(7)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/heather-a5937">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Heather</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/jersey-a5931">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Jersey</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/jersey-blend-a610">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/knit-a5933">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Knit</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/mesh-a5936">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Mesh</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/micro-fleece-a5942">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/nylon-a298">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Nylon</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/padded-a5943">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Padded</span>
                        <span class="small">(5)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/pique-a5939">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Pique</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/pique-blend-a565">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/pique-cotton-a538">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/poly-fleece-a454">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/poly-microfleece-a676">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/poly-cotton-rayon-a124">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/poly-elastane-a1334">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/polyester-a145">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Polyester</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/polyester-mesh-a664">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/polyester-viscose-a502">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/rayon-blend-a73">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/shell-a5941">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Shell</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/soft-a5938">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Soft</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/terry-a5940">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Terry</span>
                        <span class="small">(17)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/triblend-a1328">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Triblend</span>
                        <span class="small">(26)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/twill-a466">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Twill</span>
                        <span class="small">(2)</span>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/boat-neck-a5901">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Boat Neck</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/crew-neck-a22">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Crew Neck</span>
                        <span class="small">(378)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/henley-a523">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Henley</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/scoop-neck-a127">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/turtleneck-a1329">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/v-neck-a211">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>V-neck</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/zippered-a238">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Zippered</span>
                        <span class="small">(62)</span>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/baseball-a5909">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Baseball</span>
                        <span class="small">(7)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/casual-a5911">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Casual</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/football-a5903">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Football</span>
                        <span class="small">(2)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/formal-a5912">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Formal</span>
                        <span class="small">(16)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/golf-a5905">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Golf</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/gym-a5904">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Gym</span>
                        <span class="small">(30)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/hi-vis-a5918">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Hi vis</span>
                        <span class="small">(10)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/other-a160">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Other</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/outdoor-a5917">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Outdoor</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/running-a790">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Running</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/sport-performance-a5907">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/work-professional-a5908">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/yoga-a5910">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Yoga</span>
                        <span class="small">(3)</span>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/buttons-a973">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Buttons</span>
                        <span class="small">(4)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/hood-a967">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Hood</span>
                        <span class="small">(157)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/pocket-a964">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Pocket</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/thumbholes-a5949">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/zipper-a970">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Zipper</span>
                ...
                <div class="py-4 px-2" x-show="open" x-cloak x-transition>
                  ...
                  <div class=" ">
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/boxy-a5883">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Boxy</span>
                        <span class="small">(6)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/fitted-a5890">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Fitted</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/loose-fit-a5885">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Loose fit</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/muscle-fit-a5889">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/oversized-a5891">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Oversized</span>
                        <span class="small">(16)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/slim-fit-a5886">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Slim fit</span>
                        <span class="small">(5)</span>
                    ...
                    <div
                      ...
                      <a class="block bg-white my-2 p-3 rounded-lg text-lg md:text-xl text-dark-gray" href="/blank-apparel-accessories-c37029/stretch-a5884">
                        <i class="fa fa-check-square text-special" x-show="false" x-cloak></i>
                        <i class="fa fa-square-o" x-show="!false" x-cloak></i>
                        <span>Stretch</span>
                        <span class="small">(7)</span>
          ...
          <div class="w-full md:!mr-0 !px-0">
            ...
            <h1 class="mt-3 mb-4 text-xl font-bold text-center md:text-left md:text-4xl text-dark-blue">Blank Apparel Accessories <span class="text-gray-500 font-normal">wholesale and retail</span> </h1>



            <div class="flex items-center justify-between">
              <div class="font-normal text-gray-500">2290 results.</div>
              <div class="pagination-container top wordans-pagination pagination-footer">
                <div role="navigation" aria-label="Pagination" class="pagination-new"><span class="previous_page disabled" aria-label="Previous page"><img class="previous-label-icon" alt="Previous" src="https://assets.wordans.ca/assets/wordans_2024/chevron_left-ec55170ac6eb8dd95bfc0172c65c4517b42222254c8087e00fb35e17106b6b6b.svg" /></span> <em class="current">1</em> <a rel="next" href="/blank-apparel-accessories-c37029?page=2">2</a> <a href="/blank-apparel-accessories-c37029?page=3">3</a> <span class="gap"></span> <a href="/blank-apparel-accessories-c37029?page=46">46</a> <a class="next_page" aria-label="Next page" rel="next" href="/blank-apparel-accessories-c37029?page=2"><img class="next-label-icon" alt="Next" src="https://assets.wordans.ca/assets/wordans_2024/chevron_right-88b7140327f3e7abe94fcc6199c61fac16ace4221cd57aab1d1b6fbe2bf2f58a.svg" /></a></div>
              </div>
            </div>
    ...
    if ($store.profile.isLogged) {
      ...
      $store.profile.loadModal()
            ...
            <div class="pagination-container wordans-pagination pagination-footer">
              <div role="navigation" aria-label="Pagination" class="pagination-new"><span class="previous_page disabled" aria-label="Previous page"><img class="previous-label-icon" alt="Previous" src="https://assets.wordans.ca/assets/wordans_2024/chevron_left-ec55170ac6eb8dd95bfc0172c65c4517b42222254c8087e00fb35e17106b6b6b.svg" /> Previous</span> <em class="current">1</em> <a rel="next" href="/blank-apparel-accessories-c37029?page=2">2</a> <a href="/blank-apparel-accessories-c37029?page=3">3</a> <a href="/blank-apparel-accessories-c37029?page=4">4</a> <a href="/blank-apparel-accessories-c37029?page=5">5</a> <a href="/blank-apparel-accessories-c37029?page=6">6</a> <a href="/blank-apparel-accessories-c37029?page=7">7</a> <a href="/blank-apparel-accessories-c37029?page=8">8</a> <a href="/blank-apparel-accessories-c37029?page=9">9</a> <a href="/blank-apparel-accessories-c37029?page=10">10</a> <a href="/blank-apparel-accessories-c37029?page=20">20</a> <a href="/blank-apparel-accessories-c37029?page=30">30</a> <a href="/blank-apparel-accessories-c37029?page=40">40</a> <a href="/blank-apparel-accessories-c37029?page=46">46</a> <a class="next_page" aria-label="Next page" rel="next" href="/blank-apparel-accessories-c37029?page=2">Next <img class="next-label-icon" alt="Next" src="https://assets.wordans.ca/assets/wordans_2024/chevron_right-88b7140327f3e7abe94fcc6199c61fac16ace4221cd57aab1d1b6fbe2bf2f58a.svg" /></a></div>
            </div>
      ...
      <div class='wrapper no-bs grid grid-cols-12 gap-8 my-8 text-lg text-justify'>
        <div class='col-span-12'>
          <p>
          <p>Welcome to Wordans, a wholesaler of blank apparel &amp; accessories. As you can see on our website, we deliver to multiple countries around the world. Therefore, we offer our website in multiple languages. Are you looking for blank apparel in Canada? We would love to welcome you to our website. Check out our huge variety of blank clothing.</p>
          </p>
          <p>
          <p>We have many products to offer, such as <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/long-sleeves-s21954" target="_blank">long sleeves</a>, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/pants-shorts" target="_blank">pants &amp; shorts</a>, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/polos-s22991" target="_blank">polos</a>, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/t-shirts-s2729" target="_blank">t-shirts</a>, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/tank-top-s21951" target="_blank">tank tops</a>, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/jackets-s3669" target="_blank">jackets</a>, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/bags-s2737" target="_blank">bags</a>, and <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/accessories-s3670" target="_blank">accessories</a>. Understandably, it is difficult to make choices. Have you just started your own business and would like to sell clothing yourself? If so, a large selection of different kinds of blank clothing can be overwhelming. Have you not yet decided whether you would rather sell hoodies or sweatpants or do you tend towards t-shirts, where you can promote your brand even more easily? To help make life easier, we have added an extensive filter so you can make the choice that suits you best.</p>
          </p>

          <section class='content content-container row' id='' x-data='{ isExpanded: true, isCompact: true }'>
            <div @click='isExpanded = !isExpanded' class='flex items-center cursor-pointer'>
              <h2 class="mt-0 title- text-xl mb-0 *:!text-dark-blue !text-dark-blue font-bold md:text-2xl xl:text-3xl " :class="isCompact &amp;&amp; &#39;text-2xl mt-2&#39;">Easily Relabel Your Custom T-Shirt with Your Own Branding</h2>
            ...
            <div :class='!isExpanded ? &#39;hidden&#39; : &#39;block&#39;; isCompact ? &#39;mt-2&#39; : &#39;mt-8&#39;' class='section-content' style='content-visibility: auto;'>
              <p>
              <p>We are a wholesaler selling high-quality blank apparel &amp; accessories. This makes it possible to print the clothes you want. Do you have a party with friends, a family day, or a class outing? You can create matching clothing sets for you and your friends. Some items can be printed directly through <a href="https://yourtagclothing.com" target="_blank">Wordans</a>. You must then filter by custom, then click on a product of your liking, and under the product photo you will see the 'customize it!' button. Other products can still be customized, clicking the button will take you to a request form, where you can tell us your ideas. </p>
              </p>
              <p>
              <p><a href="https://www.wordans.ca/display/custom" target="_blank">Customizing</a> is very easy. You can choose a logo, a self-designed drawing, a text, or a name. In addition, it is possible to print on the front, the back, or both. Regarding the text, you can completely customize the font, colour, and font size. These items are also good for your own retail trade, as some items have tear-away labels. Also, did you know that our blank apparel &amp; accessories get cheaper when you buy them in bulk? Since we are a wholesaler, we can also bring our products to the market more cheaply. This gives you the chance to make more profit from your retail business. Choose cheap blank apparel &amp; accessories from our website.</p>
              </p>
          ...
          <section class='content content-container row' id='' x-data='{ isExpanded: true, isCompact: true }'>
            <div @click='isExpanded = !isExpanded' class='flex items-center cursor-pointer'>
              <h2 class="mt-0 title- text-xl mb-0 *:!text-dark-blue !text-dark-blue font-bold md:text-2xl xl:text-3xl " :class="isCompact &amp;&amp; &#39;text-2xl mt-2&#39;">Low-Cost Wholesale Blank Apparel &amp; Accessories for Everyone</h2>
              <div class='flex items-center ml-auto' x-cloak='true' x-show='!isExpanded'>
                <svg width="25" height="25" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="15.994" cy="16.0297" r="15.1801" transform="rotate(90 15.994 16.0297)" fill="#000E3A" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.66898 16.1389L13.039 21.2622L16.1129 21.2622L13.7594 17.3685L20.5076 17.3685L20.5076 14.8866L13.7665 14.8866L16.1129 10.9701L13.039 10.9701L9.66898 16.1389Z" fill="white" />
            ...
            <div :class='!isExpanded ? &#39;hidden&#39; : &#39;block&#39;; isCompact ? &#39;mt-2&#39; : &#39;mt-8&#39;' class='section-content' style='content-visibility: auto;'>
              <p>
              <p>For men, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/women-g24" target="_blank">women</a>, <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/kids-g10" target="_blank">children</a> and <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/baby-g16549" target="_blank">babies</a>, from small sizes to large sizes, unisex, you have come to the right place for the right fit. We have sizes available from XXS to 6XL because we try to have something for everyone. In addition, many of our sweatpants are elastic at the top and at the bottom.</p>
              </p>
              <p>
              <p>Our items are suitable for sports, for example with sweatpants and a tank top. If you want to look more formal, choose a polo or workwear, or do you prefer to go to school casually with a long sleeve? You can complete the look with a bag from <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/champion-b21311" target="_blank">Champion</a> or <a href="https://www.wordans.ca/blank-apparel-accessories-c37029/north-end-b22049" target="_blank">North End</a> for example, or a watch. You can choose from different colours and you have the option to filter. For example, if you have found a model that you like, you can choose a colour, such as red, purple, black, or white. In addition, you can filter by many more features. You can check what type of blank clothing you want, your preference for a brand, and what material. Think of polyester, cotton, nylon, and poly fleece.</p>
              </p>
              <p>
              <p>At our wholesale website for blank apparel &amp; accessories, you can purchase many types of products in bulk for your business. Of course, you can also purchase for yourself. From sportswear, to casual and chill outfits, to polo shirts and bags. At Wordans you can find different styles of clothing items. Many <a href="https://www.wordans.ca/blank-apparel-accessories-c37029#collapse-colors">colours</a>, sizes, and brands. Don't wait any longer!</p>
              </p>
